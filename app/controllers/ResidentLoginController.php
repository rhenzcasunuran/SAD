...
class ResidentLoginController extends ManageRedirectController {
    private $residentLoginModel;

    public function __construct($residentLoginModel) 
    {
        $this->residentLoginModel = $residentLoginModel;
    }
    ...
    public function loginResidentUser() 
    {
        ...
        if (isset($_POST['login-btn'])) {
            ...
            $result = $this->residentLoginModel->authenticateResident($username, $password);
