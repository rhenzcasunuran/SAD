    ...
    <div id="contentWrapper">
        ...
        <div class="row" id="contentContainer">
            <div id="content">
                ...
                <div id="rightWrapper">
                    <form action="index.php?page=resident-registration" method="POST" autocomplete="off" class="needs-validation form-container" id="form-container" oninput='confirmPassword.setCustomValidity(confirmPassword.value != password.value ? "Passwords do not match." : "")' novalidate>
                        ...
                        <div class="row h-100 form-section" id="tab-1">
                            <div class="form-group col-sm-7 has-feedback">
                                ...
                                <input type="text" class="form-control form-field name-only" id="first-name" name="first_name" required>
                            </div>
                            <div class="form-group col-sm-5 has-feedback">
                                <label for="middle-name" class="form-label">Middle Name</label>
                                <input type="text" class="form-control name-only" id="middle-name" name="middle_name">
                            </div>
                            <div class="form-group col-sm-9 has-feedback">
                                <label for="last-name" class="form-label">Last Name <span id="required">*</span></label>
                                <input type="text" class="form-control form-field name-only" id="last-name" name="last_name" required>
                            </div>
                            <div class="form-group col-sm-3 has-feedback">
                                <label for="suffix-name" class="form-label">Suffix</label>
                                <input type="text" class="form-control" id="suffix-name" name="suffix">
                            </div>
                            <div class="form-group col-sm-5 has-feedback">
                            ...
                            <div class="form-group col-sm-4 has-feedback">
                                ...
                                <select class="form-select form-field" id="civil-status" name="civil_status"  required>
                                    <option hidden value=""></option>
                        ...
                        <div class="row h-100 form-section" id="tab-2">
                            <div class="form-group col-12">
                                ...
                                <input type="text" class="form-control form-field" id="address" name="street_building_house" required>
                            </div>
                            ...
                            <div class="form-group col-sm-9">
                                ...
                                <input type="text" class="form-control form-field numeric-only" id="phone" name="phone_number" pattern="[0-9]{11}" maxlength="11" required>
                            </div>
                            <div class="form-group col-12">
                                <label for="email" class="form-label">Email <span id="required">*</span> <span id="valid"></span></label>
                                <input type="email" class="form-control form-field" id="email" name="email_address" required>
                            </div>
                        </div>
                        ...
                        <div class="row h-100 form-section" id="tab-3">
                            <div class="form-group col-12">
                                ...
                                <select class="form-select form-field" id="id" name="valid_id_type" required>
                                    <option hidden value=""></option>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control form-field numeric-w-hyphen" id="id-number" name="valid_id_number" required maxlength="36">
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="id" class="form-label">ID Issued Date <span id="required">*</span></label>
                                <input type="date" class="form-control form-field" id="id-issued-date" name="valid_id_issued" required>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    ...
                                    <input type="file" class="form-control" id="selfie-id" name="selfie_id" accept="image/png, image/jpeg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row h-100 form-section" id="tab-4">
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="input-group" id="show-hide-confirm-password">
                                    <input type="password" class="form-control form-field" id="confirm_password" name="confirm_password" required>
                                    <div class="input-group-text">
                                        <i class="bx bx-hide" aria-hidden="true"></i>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-12" id="terms-conditions-container">
                                ...
                                <div id="terms">
                                    <label for="terms-conditions" name="terms_conditions" class="form-label">I Agree with</label>
