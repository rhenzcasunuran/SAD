...
<body>
            ...
            <div id="content">
                ...
                <div id="loginWrapper">
                    <div id="loginContainer">
                        <form action="index.php?page=resident-auth" method="POST" class="needs-validation" autocomplete="off" novalidate>
                            ...
                            <span class="margin a resetPassword"> 
    ...
    <script>
        $(".createAccount").on('click', function() {
            location.href = "index.php?page=resident-registration";
        })

        $(".resetPassword").on('click', function() {
            location.href = "index.php?page=resident-select-contact";
        })
    </script>
</body>
</html>