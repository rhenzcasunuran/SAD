...
<body>
    <div class="popup-background" id="changePassword">
        <div class="row popup-container">
            <form action="" id="resetPasswordForm" class="needs-validation" novalidate  oninput='confirmPassword.setCustomValidity(confirmPassword.value != newPassword.value ? "Passwords do not match." : "")' >
            ...
            <div class="col-9 mt-5">
                <div id="information-container">
                    ...
                    <div class="row info">
                        ...
                        <p class="col-9">Kenneth Pogi Dela Cruz</p>
                    </div>
                    <div class="row info">
                        <label for="" class="col-3">Username: </label>
                        <p class="col-9">pogisiKenneth SHEESH</p>
                    </div>
                    <div class="row info">
                        <label for="" class="col-3">Email Address </label>
                        <p class="col-9">example@gmail.com</p>
                    </div>
                    <div class="row info">
